...
namespace Bookify.Infrastructure.Migrations
{
    ...
    [Migration("20260301015722_Create_Database")]
            ...
            modelBuilder.Entity("Bookify.Domain.Apartments.Apartment", b =>
                {
                    ...
                    b.OwnsOne("Bookify.Domain.Common.Money", "CleaningFee", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Common.Money", "Price", b1 =>
                        {
                            b1.Property<Guid>("ApartmentId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
            ...
            modelBuilder.Entity("Bookify.Domain.Bookings.Booking", b =>
                {
                    ...
                    b.OwnsOne("Bookify.Domain.Common.Money", "AmenitiesUpCharge", b1 =>
                        {
                    ...
                    b.OwnsOne("Bookify.Domain.Common.Money", "PriceForPeriod", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
                    ...
                    b.OwnsOne("Bookify.Domain.Common.Money", "TotalPrice", b1 =>
                        {
                            b1.Property<Guid>("BookingId")
                                .HasColumnType("uuid")
                                .HasColumnName("id");
